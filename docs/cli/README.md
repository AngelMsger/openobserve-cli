...
| Command | Description |
| --- | --- |
| [`openobserve-cli skill`](https://angelmsger.github.io/openobserve-cli/cli/#openobserve-cli-skill) | Install the companion Skill for coding agents (Claude Code, Codex, Grok Build) |
